...
<head>
    ...
    <title>{{env('APP_NAME', "Copy Ai")}}</title>
    <!-- Styles -->
    <script>
        window.app_url = "{{config('shopify.SHOPIFY_APP_URL')}}";
    </script>
    <link href="{{ asset('standalonecss/standapp.css?v='.rand(0,2999)) }}" rel="stylesheet">
...
<body>
    ...
    <script src="{{ asset('standalonejs/standapp.js?v='.rand(0,2000)) }}"></script>
</body>
</html>
...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link href="{{asset('standalonecss/style.css')}}" rel="stylesheet">
        <script>
            window.app_url = "{{config('shopify.SHOPIFY_APP_URL')}}";
        </script>
    </head>
    <body class="antialiased">
        <div class="container">
            <div>
                ...
                <div> 
                    <p class="text-center s-welcome">Welcome</p>
                </div>
                <div> 
                    <p class="text-center s-greeting"> Set The App On Your Store</p>
                </div>
                <div>
                    <p class="text-center s-short-des"> Start optimizing your product description and increase revenue in just 3 simple phase </p>
                </div>

            </div>
            <div class="form-group mt-3"> 
                <p class="text-center "> <i> - Enter Your Store Name To Begin - </i></p>
                <div class="row m-auto col-md-6">
                    <input type="text" class="col-md-6 col-sm-6 col-12 " name="domain">
                    <input type="submit" class="col-md-6 col-sm-6 col-12 " role="button"> 
                </div>
            </div>
            <div class="row"> 
                <div> 
                    <svg height="25px" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
